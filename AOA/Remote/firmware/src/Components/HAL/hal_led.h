...
#define HAL_LED1_PIN        GPIO_Pin_3			//绿灯(工作指示灯PA3)
#define HAL_LED2_PIN        GPIO_Pin_4			//红灯(报警指示灯PB4)
#define HAL_LED3_PIN        GPIO_Pin_2			//蓝灯(充电指示灯PA2)
#define HAL_LED4_PIN        NULL
	
#define HAL_BEEP_RCC        RCC_APB2Periph_GPIOB
#define HAL_BEEP_PORT       GPIOB
#define HAL_BEEP_PIN        GPIO_Pin_14
 ...
 * 使能LED
 */
extern void HalLedInit(bool power);
