...
#define HAL_KEY6_Shut_PORT_SOURCE       GPIO_PortSourceGPIOA
#define HAL_KEY6_Shut_PIN_SOURCE        GPIO_PinSource1
#define HAL_KEY6_Shut_EXTI_LIN          EXTI_Line1
#define HAL_KEY6_Shut_EXIT_IRQN         EXTI1_IRQn
